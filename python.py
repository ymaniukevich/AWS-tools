...
def find_unused_security_group(ec2_client, sg_id, sg_name, unused_count, used_count):
    ...
    if len(checking['NetworkInterfaces']) == 0:
        ...
        if args.delete and sg_name != "default":
            try:
                ...
                print("Security group {0} isn't deleted. {1}".format(sg_id,e))
        return "UNUSED"
    else:
    ...
    for aws_profile in aws_profiles:
        ...
        for aws_region in aws_regions[aws_profile]:
            ...
            for security_group in security_groups:
                ...
                state = find_unused_security_group(ec2, sg_id, sg_name, sg_statistics["Unused sg"], sg_statistics["Used sg"])
                sg_statistics["Total sg"].add(sg_id)
                if sg_id == "sg-0736738db1f9c51fd":
